package com.gklyphon.sabor_digital.waiter.infrastructure.config.security;
...
/**
 * Security configuration class for the Waiter microservice.
...
@Configuration
@EnableWebSecurity
public class WaiterSecurityConfig {

    private final String[] PUBLIC_ENDPOINTS = {};

    private final String[] AUTHENTICATED_ENDPOINTS = {
            "/api/waiters", "/api/waiters/by-restaurant/{id}",
            "/api/waiters/{id}", "/api/waiters/by-ids"
    };
